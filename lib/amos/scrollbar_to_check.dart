...
class ScrollbarWidget2 extends StatelessWidget {
  ///need to check this later
  const ScrollbarWidget2({
    super.key,
    required this.child,
    this.controller,
  ...
  }) : assert(trackVisibility != true || trackRadius != null,
            'trackRadius must be provided if trackVisibility is true.');
  ...
  /// The [Radius] of the outer track's rounded rectangle corners.
  ///
  /// If null and [trackVisibility] is true, an assertion error will be thrown.
...
/// widget in a [ScrollbarWidget] widget.
///
...
///
/// {@tool dartpad}
/// This sample shows a [ScrollbarWidget] that executes a fade animation as scrolling
/// occurs. The ScrollbarWidget will fade into view as the user scrolls, and fade out
...
/// that the [ScrollbarWidget] is always visible, since scrolling in the horizontal
...
///  * [ScrollbarTheme], which configures the ScrollbarWidget's appearance.
...
class CheckboxWidget extends StatefulWidget {
  ...
  CheckboxWidget(
      {required this.initialValue, required this.onChanged, this.text});
  ...
  Widget build(BuildContext context) {
    return Row(
      children: [
        ...
        if (widget.text != null) ...[Gap(1), Text(widget.text!)]
