...
// ///
// const double _kScrollbarThickness = 14.0; //8
// const double _kScrollbarThicknessWithTrack = 22.0; //12
// const double _kScrollbarMargin = 3.0; //2.0
// const double _kScrollbarMinLength = 36.0; //48
// const Radius _kScrollbarRadius = Radius.circular(8.0);
// const Duration _kScrollbarFadeDuration = Duration(milliseconds: 300);
// const Duration _kScrollbarTimeToFade = Duration(milliseconds: 600);

// class CustomScrollBarWithNoColor extends StatelessWidget {
//   const CustomScrollBarWithNoColor({
//     super.key,
//     required this.child,
//     this.controller,
